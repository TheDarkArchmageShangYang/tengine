#define NGX_CONFIGURE " --prefix=/home/fzchen/Ditto/tengine-install --sbin-path=sbin/tengine --with-xquic-inc=../xquic-1.6.0/include --with-xquic-lib=../xquic-1.6.0/build --with-http_v2_module --without-http_rewrite_module --add-module=modules/ngx_http_xquic_module --with-openssl=../Tongsuo-8.3.2 --with-cc-opt='-I ../xquic-1.6.0/third_party/libxml2/include/libxml2' --with-ld-opt='-L ../xquic-1.6.0/third_party/libxml2/lib -lxml2 -lz -lm'"
...
#ifndef T_PIPE_SET_SIZE
#define T_PIPE_SET_SIZE  1
#endif
...
#ifndef T_NGX_HTTPS_ALLOW_HTTP
#define T_NGX_HTTPS_ALLOW_HTTP  1
#endif


#ifndef T_NGX_REQUEST_START_TIME
#define T_NGX_REQUEST_START_TIME  1
#endif


#ifndef T_NGX_SOCKET_BUFFER
#define T_NGX_SOCKET_BUFFER  1
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/fzchen/Ditto/tengine-install/"
#endif
...
#define NGX_SBIN_PATH  "sbin/tengine"
#endif
